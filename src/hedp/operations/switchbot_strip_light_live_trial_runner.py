"""Safe environment-backed entry point for the bounded Strip Light 3 trial."""
...
def run_from_environment(
    ...
    try:
        status_transport = BoundedStripStatusTransport(token, secret)
...
def main() -> int:
    ...
    return 0 if summary["reason"] == "changed_and_restored" else 2
