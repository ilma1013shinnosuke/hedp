...
: "${HEDP_FUSIONSOLAR_MODBUS_HOST:?Set HEDP_FUSIONSOLAR_MODBUS_HOST before installing.}"
: "${HEDP_FUSIONSOLAR_MODBUS_PORT:?Set HEDP_FUSIONSOLAR_MODBUS_PORT before installing.}"
...
umask 077
{
    ...
    for name in HEDP_FUSIONSOLAR_BASE_URL HEDP_FUSIONSOLAR_STATION_DN HEDP_FUSIONSOLAR_USERNAME HEDP_FUSIONSOLAR_PASSWORD HEDP_FUSIONSOLAR_DEVICE_DNS HEDP_FUSIONSOLAR_BATTERY_DN HEDP_FUSIONSOLAR_BATTERY_SIGIDS HEDP_FUSIONSOLAR_MODBUS_HOST HEDP_FUSIONSOLAR_MODBUS_PORT HEDP_FUSIONSOLAR_MODBUS_UNIT_ID HEDP_FUSIONSOLAR_MODBUS_EXPECTED_SERIAL; do
