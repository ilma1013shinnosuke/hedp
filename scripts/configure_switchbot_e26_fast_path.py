#!/usr/bin/env python3
"""Resolve one E26 device once and store its private binding in .env."""
...
_NAME = "SWITCHBOT_E26_DEVICE_ID"


def resolve_unique_e26(payload: dict[str, Any]) -> str:
    return resolve_unique_device(payload, "Color Bulb")
...
def main() -> int:
    ...
    print("E26 fast path configured safely; private identifier was not displayed.")
    return 0
